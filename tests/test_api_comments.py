...
class VideoCommentAPITest(APITestCase):
    ...
    def test_authenticated_user_can_read_comment_list(self):
        ...
        response = self.client.get('/api/v1/video-comments/')
    ...
    def test_authenticated_user_can_read_comment_detail(self):
        ...
        response = self.client.get(f'/api/v1/video-comments/{self.comment.id}/')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_comment_filter_by_exercise(self):
        ...
        response = self.client.get(f'/api/v1/video-comments/?exercise={self.exercise.id}')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
        self.assertEqual(len(response.data), 1)
    ...
    def test_author_can_update_own_comment(self):
        ...
        response = self.client.patch(f'/api/v1/video-comments/{self.comment.id}/', data)
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_author_can_replace_own_comment_video(self):
        ...
        response = self.client.patch(f'/api/v1/video-comments/{self.comment.id}/', data, format='multipart')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_author_can_delete_own_comment(self):
        ...
        response = self.client.delete(f'/api/v1/video-comments/{self.comment.id}/')
    ...
    def test_comment_ordering(self):
        ...
        response = self.client.get('/api/v1/video-comments/?ordering=-created_at')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
        self.assertEqual(len(response.data), 1)
