...
export default function SkillPickerModal({
  ...
  if (!open) return null
  return (
    <div className="fixed inset-0 z-[120]" role="dialog" aria-modal="true" aria-labelledby="skill-modal-title">
      ...
      <div className="absolute inset-0 flex items-center justify-center px-4">
        <div className="w-full max-w-md rounded-2xl bg-white border border-gray-200 shadow-2xl p-4 space-y-3">
          <div className="flex items-center justify-between">
            <p id="skill-modal-title" className="text-sm font-semibold text-gray-900">{title}</p>
          ...
          <SkillField
            ...
            placeholder="Choose or create a skill"
          />
