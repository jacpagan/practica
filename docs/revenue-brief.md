# Practica Revenue Brief

## Status

This is a business prompt, not the product SSOT.

Use this file when you want the AI to think about revenue growth, packaging, pricing, and what to build for paying customers.
...
Do not widen the market before the primary buyer is paying.
...
The buyer is not paying for novelty.
The buyer is paying for reduced friction and better follow-through.
...
Start with a pricing hypothesis, not a final price.
...
- billing complexity before buyer pain is proven
...
- `docs/practica-master-spec.md` says what Practica is
- this file says how Practica should make money
- `AGENTS.md` says how the AI should work in the repo
- `docs/tdd-strategy.md` says how to protect the core loop
